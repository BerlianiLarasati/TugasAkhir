                        ...
                        <div class="card-header py-3">
                            <div class="row">
                                ...
                                <div class="col-6 d-flex justify-content-end">
                                    <a class="btn-close btn-outline-primary" aria-label="close" href="{{ route('umkm') }}" role="button"></a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                <form action="{{ route('storeUmkm') }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="umkm_toko" id="title"
                                            class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="title">Alamat Umkm</label>
                                        <input type="text" name="umkm_alamat" id="title"
                                            class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="title">Kontak</label>
                                        <input type="text" name="umkm_kontak" id="title"
                                            class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="title">Onlineshop</label>
                                        <input type="text" name="umkm_onlineshop" id="title"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
