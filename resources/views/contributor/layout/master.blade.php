...
<head>
  @include('contributor.layout.include.head')
</head>
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
  ...
  <div id="wrapper">
    ...
    <!-- Topbar Start -->
    @include('contributor.layout.include.navbar')
    <!-- end Topbar -->

    <!-- ========== Left Sidebar Start ========== -->
    @include('contributor.layout.include.leftsidebar')
    <!-- Left Sidebar End -->
    ...
    <div class="content-page">
      ...
      <!-- Footer Start -->
      @include('contributor.layout.include.footer')
      <!-- end Footer -->
  ...
  <!-- Right Sidebar -->
  @include('contributor.layout.include.rightsidebar')
  <!-- /Right-bar -->
