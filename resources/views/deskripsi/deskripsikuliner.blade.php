...
{{-- ----------punya ardi desainnya kureng-------- --}}
    ...
    <div>
      ...
      <div class="d-flex justify-content-center">
        <img class="mb-4" src="{{asset('fotokuliner/'.$kuliner->foto)}}" alt="" style="height:500px;width:1000px"> 
      </div>
      <div class="d-flex flex-row mb-2 justify-content-center">
      <h6 class="fw-semibold p-2"><i class="fa fa-fw fa-map-marker-alt"></i> {{$kuliner->address}}</h6>
      <h6 class="fw-semibold p-2"><i class="fa-sharp fa-solid fa-tags"></i> {{$kuliner->kategori}}</h6>
      </div>
