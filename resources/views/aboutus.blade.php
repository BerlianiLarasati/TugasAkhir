    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-home navbar-nav">
                ...
                <li><a class="nav-link active-nav" href="{{ route('aboutus') }}">About Us</a></li> 
        ...
        <div class="responsive-container-block container">
            <div class="responsive-container-block">
              <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                <div class="card">
                  <div class="team-image-wrapper">
                    <img class="team-member-image" src="{{asset('/assets/img/team-member/Ardi Pratama.jpg')}}">
                  </div>
                  ...
                  <div class="social-icons">
                    <a href="https://github.com/Pratamaardhy">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.instagram.com/pratamaardhy_">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/pratamaardhy/">
              ...
              <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                <div class="card">
                  <div class="team-image-wrapper">
                    <img class="team-member-image" src="{{asset('/assets/img/team-member/Bagus Untoro.jpg')}}">
                  </div>
                  <p class="text-blk name">
                    Bagus Untoro
                  </p>
                  ...
                  <div class="social-icons">
                    <a href="https://github.com/bagusuntoro">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.instagram.com/untoro.bagus/">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href=https://id.linkedin.com/in/bagus-untoro-aa113a226?trk=public_profile_samename-profile">
                        <i class="fab fa-linkedin"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                <div class="card">
                  <div class="team-image-wrapper">
                    <img class="team-member-image" src="{{asset('/assets/img/team-member/Althea.jpg')}}">
                  </div>
                  <p class="text-blk name">
                    Putu Althea Putri
                  </p>
                  ...
                  <div class="social-icons">
                    <a href="https://github.com/putualthea">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.instagram.com/putualthea/">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/putualtheaputri/">
                        <i class="fab fa-linkedin"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                <div class="card">
                  <div class="team-image-wrapper">
                    <img class="team-member-image" src="{{asset('/assets/img/team-member/user.jpg')}}">
                  </div>
                  <p class="text-blk name">
                    Berliani Larasati
                  </p>
                  ...
                  <div class="social-icons">
                    <a href="https://github.com/BerlianiLarasati" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.instagram.com/berlianilaras/" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
              ...
              <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                <div class="card">
                  ...
                  <div class="social-icons">
                    <a href="https://github.com/ReynisaBetaNurlyan" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.instagram.com/reynisabn/" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com" target="_blank">
                        <i class="fab fa-linkedin"></i>
