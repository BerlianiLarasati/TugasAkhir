    ...
    <div class="layar-penuh">
      <header id="home">
        ...
        <video autoplay muted loop>
          <source src="{{ asset ('/assets/video/surabaya.mp4')}}" type="video/mp4"/>
        </video>
        <div class="intro">
          ...
          <div class="ripple">
            <div class="icon">
              <a class="a1" href="{{ route('publicDestinasi') }}"
                ><i class="fa-solid fa-archway"></i><br />
                Destinasi <br />
                Wisata</a
              >
              <a class="a1" href="{{ route('publicUmkm') }}"
        ...
        <div class="col-10 mx-auto">
          <div class="isi-satu row justify-content-center">
            <div class="col-3 text-center my-2">
              <a href="">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-event.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-maps.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-culinary.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="{{route('publicUmkm')}}">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-shopping.png" alt="" />
                <br />
                <h6 class="font-weight-bold my-2">Shopping</h6>
              </a>
            </div>  
            <div class="col-3 text-center my-2">
              <a href="{{ route('publicDestinasi') }}">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-outdoornature.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="{{ route('publicDestinasi') }}">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-hotel.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="{{ route('publicDestinasi') }}">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-heritage.png" alt="" />
                <br />
            ...
            <div class="col-3 text-center my-2">
              <a href="">
                <img class="img-fluid" style="object-fit: cover" src="{{ asset ('/assets/icons')}}/icon-faq.png" alt="" />
                <br />
            ...
            <div class="row">
              ...
              <div class="col-4">
                <div class="text-right">
                  <img
                    src="{{ asset ('/assets/icons')}}/icon-360.png"
            ...
            <div class="row">
              <div class="col-md-12 text-center">
                <div class="container_video_overlay">
                  ...
                  >
                    <source src="{{ asset ('/assets/video/360.mp4')}}" type="video/mp4" />
                  </video>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="text-center">
                  <img src="{{ asset ('/assets/icons')}}/icon-sign.png" alt="" />
                  <h3>
                    Start Your Best <br />
                    Journey In Surabaya
                  </h3>
                ...
                <div class="row">
                  <div class="col-md-12 my-4">
                    <a class="text-dark w-100">
                      ...
                      >
                        <div class="img-hover">
                          <img
                            src="{{ asset ('/assets/img/home')}}/Gedung.jpg"
                  ...
                  <div class="col-md-12 my-4">
                    ...
                    >
                      <div class="img-hover">
                        <img
                          src="{{ asset ('/assets/img/home')}}/Piala Walikota.png"
                ...
                <div class="row">
                  <div class="col-md-12 my-4">
                    ...
                    >
                      <div class="img-hover">
                        <img
                          src="{{ asset ('/assets/img/home')}}/hotel.jpg"
                  ...
                  <div class="col-md-12 my-4">
                    ...
                    >
                      <div class="img-hover">
                        <img
                          src="{{asset('/assets/img/home')}}/balai.jpg"
